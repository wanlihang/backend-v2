      ...
      <div class="form-box broder-top-left-radius">
        <el-form ref="form" :model="course" :rules="rules" label-width="200px">
          ...
          <el-form-item label="订阅人数" prop="count">
            <el-input v-model="course.user_count" class="w-200px"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    detail() {
      this.$api.Meedubook.Book.Detail(this.course.id).then((res) => {
        var data = res.data;
        ...
        this.course.is_vip_free = data.is_vip_free;
      });
    },
    formValidate() {
    ...
    confirm() {
      ...
      this.$api.Meedubook.Book.Update(this.course.id,this.course)
        .then(() => {
