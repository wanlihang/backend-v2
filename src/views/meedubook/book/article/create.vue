    ...
    <div class="float-left">
      ...
      <div class="bottom-menus">
        <div class="bottom-menus-box">
          ...
          <div class="ml-24">
            <el-button @click="$router.push({ name: 'MeedubookArticle' ,query: { bid: book_id},})"
              >取消</el-button
            >
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      this.loading = true;
      this.$api.Meedubook.Book.Article.Store(this.course)
        .then(() => {
          this.$message.success(this.$t("common.success"));
          this.$router.push({ name: "MeedubookArticle" ,query: { bid: this.book_id},});
        })
        .catch((e) => {
          this.loading = false;
