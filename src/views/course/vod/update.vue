  ...
  <div class="float-left">
    <div class="form-box broder-top-left-radius">
      <el-form ref="form" :model="course" :rules="rules" label-width="200px">
        ...
        <el-form-item prop="original_desc" label="详细介绍" v-if="course.original_desc">
          <wang-editor class="w-100" v-model="course.original_desc"></wang-editor>
        </el-form-item>
