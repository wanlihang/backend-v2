    ...
    <template v-if="isLoading">
      <div class="float-left">
        ...
        <div class="helper-text">
          1.如果更新菜单失败，请先「删除菜单」之后，重新编辑菜单，再「更新菜单」。
        </div>
        <div class="helper-text">
          2.如果您的公众号在使用本菜单编辑器之前已经配置了公众号菜单的话，那么请先点击「删除菜单」，然后在本地重新编辑菜单之后，提交「更新菜单」。
        </div>
        <div class="helper-text">
          3.菜单编辑之后需要点击「更新菜单」按钮将更改同步到微信公众号，这样才是一次正确的菜单更新操作。
        </div>
        <div class="helper-text">
          4.点击「更新菜单」按钮之后，已修改的公众号菜单并不是立马就可以看到，至少需要等待10分钟左右的时间，才会看到最新修改的菜单。
        </div>
        <div class="helper-text">
          5.自定义菜单最多包括3个一级菜单，每个一级菜单最多包含5个二级菜单。
        </div>
        <div class="helper-text">
          6.一级菜单最多4个汉字，二级菜单最多8个汉字，多出来的部分将会以“...”代替。
        </div>
      </div>
