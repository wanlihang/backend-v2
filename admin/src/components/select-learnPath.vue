<template>
  <div class="meedu-dialog-mask" v-if="show">
    <div class="meedu-dialog-box">
      <div class="meedu-dialog-header">选择学习路径</div>
      <div class="meedu-dialog-body">
        <div class="courses-box">
          ...
          >
            ...
            <el-table-column prop="id" label="路径ID" width="120">
            </el-table-column>
  ...
  methods: {
    ...
    confirm() {
      ...
      this.$emit("change", {
        ...
        courses_count: this.result.courses_count,
        steps_count: this.result.steps_count,
      });
    },
    close() {
      this.radio = "";
