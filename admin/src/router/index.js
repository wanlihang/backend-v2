...
const routes = [
    ...
    {
        path: "/creditMall/index",
        component: () => import("@/views/creditMall/index"),
        name: "CreditMall",
        meta: {
            title: "title.creditMall.index",
            keepAlive: true,
        },
    },
    {
        path: "/creditMall/create",
        component: () => import("@/views/creditMall/create"),
        name: "CreditMallCreate",
        meta: {
            title: "title.creditMall.create",
        },
    },
    {
        path: "/creditMall/update",
        component: () => import("@/views/creditMall/update"),
    ...
    {
        path: "/ilabEnvironment/edit",
        component: () => import("@/views/ilabEnvironment/edit"),
        name: "EnvironmentEdit",
        meta: {
            title: "title.environment.edit",
        },
    },
    {
        path: "/ilabTemplate/storehouse",
        component: () => import("@/views/ilabTemplate/storehouse"),
        name: "TemplateEdit",
        meta: {
            title: "title.template.storehouse",
        },
    },
    {
        path: "/ilabTemplate/load",
        component: () => import("@/views/ilabTemplate/load"),
        name: "TemplateLoad",
        meta: {
            title: "title.template.storehouse",
        },
