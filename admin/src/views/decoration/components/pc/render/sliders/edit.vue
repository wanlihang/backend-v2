      ...
      <div class="meedu-dialog-body">
        <el-form ref="form" :model="form" :rules="rules" label-width="200px">
          ...
          <el-form-item label="幻灯片" prop="thumb">
            <upload-image v-model="form.thumb" :width="400" :height="100" helper="推荐尺寸1200x400 宽高比3:1"></upload-image>
          </el-form-item>
...
export default {
  ...
  methods: {
    getData() {
      this.$api.System.Sliders.Detail(this.id).then((res) => {
        this.form = res.data;
      });
    },
    formValidate() {
    ...
    confirm() {
      ...
      this.loading = true;
      this.$api.System.Sliders.Update(this.id, this.form)
        .then(() => {
