<template>
  <div class="vod-v1-box" v-if="config">
    ...
    <div class="config-item">
      <div class="config-item-title">公众号名称</div>
      <div class="config-item-body">
        <el-input v-model="config.name" class="w-100"></el-input>
      </div>
    </div>

    <div class="config-item">
      <div class="config-item-title">公众号简介</div>
      <div class="config-item-body">
        <el-input v-model="config.desc" class="w-100"></el-input>
      </div>
    </div>
